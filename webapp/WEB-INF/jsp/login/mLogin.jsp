...
<head>
    ...
    <script type="text/javascript" src="${ctx}/resource/js/pintuer.js"></script>
</head>
<body>
        ...
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="${ctx}/login/toLogin" method="post">
                ...
                <div class="panel-body" style="padding: 30px;padding-bottom: 10px;padding-top: 10px;">
                    ...
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="password" class="input input-big" name="passWord" value="111111" placeholder="输入密码" data-validate="required:请填写密码">
                            <span class="icon icon-user margin-small"></span>
                        </div>
                    </div>
